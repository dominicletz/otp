...
-record(wxActivate,{type :: wxActivateEvent:wxActivateEventType(), %% Callback event: {@link wxActivateEvent}
	active :: boolean()}).
-type wxActivate() :: #wxActivate{}. %% Callback event: {@link wxActivateEvent}

-record(wxAuiManager,{type :: wxAuiManagerEvent:wxAuiManagerEventType(), %% Callback event: {@link wxAuiManagerEvent}
...
-record(wxAuiNotebook,{type :: wxAuiNotebookEvent:wxAuiNotebookEventType(), %% Callback event: {@link wxAuiNotebookEvent}
...
-record(wxBookCtrl,{type :: wxBookCtrlEvent:wxBookCtrlEventType(), %% Callback event: {@link wxBookCtrlEvent}
	nSel :: integer(),
	nOldSel :: integer()}).
-type wxBookCtrl() :: #wxBookCtrl{}. %% Callback event: {@link wxBookCtrlEvent}

-record(wxCalendar,{type :: wxCalendarEvent:wxCalendarEventType(), %% Callback event: {@link wxCalendarEvent}
	wday :: wx:wx_enum(),
	date :: wx:wx_datetime()}).
-type wxCalendar() :: #wxCalendar{}. %% Callback event: {@link wxCalendarEvent}

-record(wxChildFocus, {type :: wxChildFocusEvent:wxChildFocusEventType()}). %% Callback event: {@link wxChildFocusEvent}
-type wxChildFocus() :: #wxChildFocus{}. %% Callback event: {@link wxChildFocusEvent}

-record(wxClipboardText, {type :: wxClipboardTextEvent:wxClipboardTextEventType()}). %% Callback event: {@link wxClipboardTextEvent}
-type wxClipboardText() :: #wxClipboardText{}. %% Callback event: {@link wxClipboardTextEvent}

-record(wxClose, {type :: wxCloseEvent:wxCloseEventType()}). %% Callback event: {@link wxCloseEvent}
-type wxClose() :: #wxClose{}. %% Callback event: {@link wxCloseEvent}

-record(wxColourPicker,{type :: wxColourPickerEvent:wxColourPickerEventType(), %% Callback event: {@link wxColourPickerEvent}
	colour :: wx:wx_colour()}).
-type wxColourPicker() :: #wxColourPicker{}. %% Callback event: {@link wxColourPickerEvent}

-record(wxCommand,{type :: wxCommandEvent:wxCommandEventType(), %% Callback event: {@link wxCommandEvent}
	cmdString :: unicode:chardata(),
	commandInt :: integer(),
	extraLong :: integer()}).
-type wxCommand() :: #wxCommand{}. %% Callback event: {@link wxCommandEvent}

-record(wxContextMenu,{type :: wxContextMenuEvent:wxContextMenuEventType(), %% Callback event: {@link wxContextMenuEvent}
	pos :: {X::integer(), Y::integer()}}).
-type wxContextMenu() :: #wxContextMenu{}. %% Callback event: {@link wxContextMenuEvent}

-record(wxDate,{type :: wxDateEvent:wxDateEventType(), %% Callback event: {@link wxDateEvent}
	date :: wx:wx_datetime()}).
-type wxDate() :: #wxDate{}. %% Callback event: {@link wxDateEvent}

-record(wxDisplayChanged, {type :: wxDisplayChangedEvent:wxDisplayChangedEventType()}). %% Callback event: {@link wxDisplayChangedEvent}
-type wxDisplayChanged() :: #wxDisplayChanged{}. %% Callback event: {@link wxDisplayChangedEvent}

-record(wxDropFiles,{type :: wxDropFilesEvent:wxDropFilesEventType(), %% Callback event: {@link wxDropFilesEvent}
	pos :: {X::integer(), Y::integer()},
	files :: [unicode:chardata()]}).
-type wxDropFiles() :: #wxDropFiles{}. %% Callback event: {@link wxDropFilesEvent}

-record(wxErase,{type :: wxEraseEvent:wxEraseEventType(), %% Callback event: {@link wxEraseEvent}
	dc :: wxDC:wxDC()}).
-type wxErase() :: #wxErase{}. %% Callback event: {@link wxEraseEvent}

-record(wxFileDirPicker,{type :: wxFileDirPickerEvent:wxFileDirPickerEventType(), %% Callback event: {@link wxFileDirPickerEvent}
	path :: unicode:chardata()}).
-type wxFileDirPicker() :: #wxFileDirPicker{}. %% Callback event: {@link wxFileDirPickerEvent}

-record(wxFocus,{type :: wxFocusEvent:wxFocusEventType(), %% Callback event: {@link wxFocusEvent}
	win :: wxWindow:wxWindow()}).
-type wxFocus() :: #wxFocus{}. %% Callback event: {@link wxFocusEvent}

-record(wxFontPicker,{type :: wxFontPickerEvent:wxFontPickerEventType(), %% Callback event: {@link wxFontPickerEvent}
	font :: wxFont:wxFont()}).
-type wxFontPicker() :: #wxFontPicker{}. %% Callback event: {@link wxFontPickerEvent}

-record(wxGrid,{type :: wxGridEvent:wxGridEventType(), %% Callback event: {@link wxGridEvent}
	row :: integer(),
	col :: integer(),
	pos :: {X::integer(), Y::integer()},
	selecting :: boolean(),
...
-record(wxHelp, {type :: wxHelpEvent:wxHelpEventType()}). %% Callback event: {@link wxHelpEvent}
-type wxHelp() :: #wxHelp{}. %% Callback event: {@link wxHelpEvent}

-record(wxHtmlLink,{type :: wxHtmlLinkEvent:wxHtmlLinkEventType(), %% Callback event: {@link wxHtmlLinkEvent}
	linkInfo :: wx:wx_wxHtmlLinkInfo()}).
-type wxHtmlLink() :: #wxHtmlLink{}. %% Callback event: {@link wxHtmlLinkEvent}

-record(wxIconize,{type :: wxIconizeEvent:wxIconizeEventType(), %% Callback event: {@link wxIconizeEvent}
	iconized :: boolean()}).
-type wxIconize() :: #wxIconize{}. %% Callback event: {@link wxIconizeEvent}

-record(wxIdle, {type :: wxIdleEvent:wxIdleEventType()}). %% Callback event: {@link wxIdleEvent}
-type wxIdle() :: #wxIdle{}. %% Callback event: {@link wxIdleEvent}

-record(wxInitDialog, {type :: wxInitDialogEvent:wxInitDialogEventType()}). %% Callback event: {@link wxInitDialogEvent}
-type wxInitDialog() :: #wxInitDialog{}. %% Callback event: {@link wxInitDialogEvent}

-record(wxJoystick,{type :: wxJoystickEvent:wxJoystickEventType(), %% Callback event: {@link wxJoystickEvent}
	pos :: {X::integer(), Y::integer()},
	zPosition :: integer(),
...
-record(wxKey,{type :: wxKeyEvent:wxKeyEventType(), %% Callback event: {@link wxKeyEvent}
	x :: integer(),
	y :: integer(),
	keyCode :: integer(),
	controlDown :: boolean(),
...
-record(wxList,{type :: wxListEvent:wxListEventType(), %% Callback event: {@link wxListEvent}
	code :: integer(),
...
-record(wxMaximize, {type :: wxMaximizeEvent:wxMaximizeEventType()}). %% Callback event: {@link wxMaximizeEvent}
-type wxMaximize() :: #wxMaximize{}. %% Callback event: {@link wxMaximizeEvent}

-record(wxMenu,{type :: wxMenuEvent:wxMenuEventType(), %% Callback event: {@link wxMenuEvent}
	menuId :: integer(),
	menu :: wxMenu:wxMenu()}).
-type wxMenu() :: #wxMenu{}. %% Callback event: {@link wxMenuEvent}

-record(wxMouseCaptureChanged, {type :: wxMouseCaptureChangedEvent:wxMouseCaptureChangedEventType()}). %% Callback event: {@link wxMouseCaptureChangedEvent}
-type wxMouseCaptureChanged() :: #wxMouseCaptureChanged{}. %% Callback event: {@link wxMouseCaptureChangedEvent}

-record(wxMouseCaptureLost, {type :: wxMouseCaptureLostEvent:wxMouseCaptureLostEventType()}). %% Callback event: {@link wxMouseCaptureLostEvent}
-type wxMouseCaptureLost() :: #wxMouseCaptureLost{}. %% Callback event: {@link wxMouseCaptureLostEvent}

-record(wxMouse,{type :: wxMouseEvent:wxMouseEventType(), %% Callback event: {@link wxMouseEvent}
	x :: integer(),
	y :: integer(),
	leftDown :: boolean(),
	middleDown :: boolean(),
...
-record(wxMove,{type :: wxMoveEvent:wxMoveEventType(), %% Callback event: {@link wxMoveEvent}
	pos :: {X::integer(), Y::integer()},
	rect :: {X::integer(), Y::integer(), W::integer(), H::integer()}}).
-type wxMove() :: #wxMove{}. %% Callback event: {@link wxMoveEvent}

-record(wxNavigationKey,{type :: wxNavigationKeyEvent:wxNavigationKeyEventType(), %% Callback event: {@link wxNavigationKeyEvent}
	dir :: boolean(),
	focus :: wxWindow:wxWindow()}).
-type wxNavigationKey() :: #wxNavigationKey{}. %% Callback event: {@link wxNavigationKeyEvent}

-record(wxPaint, {type :: wxPaintEvent:wxPaintEventType()}). %% Callback event: {@link wxPaintEvent}
-type wxPaint() :: #wxPaint{}. %% Callback event: {@link wxPaintEvent}

-record(wxPaletteChanged, {type :: wxPaletteChangedEvent:wxPaletteChangedEventType()}). %% Callback event: {@link wxPaletteChangedEvent}
-type wxPaletteChanged() :: #wxPaletteChanged{}. %% Callback event: {@link wxPaletteChangedEvent}

-record(wxQueryNewPalette, {type :: wxQueryNewPaletteEvent:wxQueryNewPaletteEventType()}). %% Callback event: {@link wxQueryNewPaletteEvent}
-type wxQueryNewPalette() :: #wxQueryNewPalette{}. %% Callback event: {@link wxQueryNewPaletteEvent}

-record(wxSash,{type :: wxSashEvent:wxSashEventType(), %% Callback event: {@link wxSashEvent}
	edge :: wx:wx_enum(),
	dragRect :: {X::integer(), Y::integer(), W::integer(), H::integer()},
	dragStatus :: wx:wx_enum()}).
-type wxSash() :: #wxSash{}. %% Callback event: {@link wxSashEvent}

-record(wxScroll,{type :: wxScrollEvent:wxScrollEventType(), %% Callback event: {@link wxScrollEvent}
	commandInt :: integer(),
	extraLong :: integer()}).
-type wxScroll() :: #wxScroll{}. %% Callback event: {@link wxScrollEvent}

-record(wxScrollWin,{type :: wxScrollWinEvent:wxScrollWinEventType(), %% Callback event: {@link wxScrollWinEvent}
	commandInt :: integer(),
	extraLong :: integer()}).
-type wxScrollWin() :: #wxScrollWin{}. %% Callback event: {@link wxScrollWinEvent}

-record(wxSetCursor,{type :: wxSetCursorEvent:wxSetCursorEventType(), %% Callback event: {@link wxSetCursorEvent}
	x :: integer(),
	y :: integer(),
	cursor :: wxCursor:wxCursor()}).
-type wxSetCursor() :: #wxSetCursor{}. %% Callback event: {@link wxSetCursorEvent}

-record(wxShow,{type :: wxShowEvent:wxShowEventType(), %% Callback event: {@link wxShowEvent}
	show :: boolean()}).
-type wxShow() :: #wxShow{}. %% Callback event: {@link wxShowEvent}

-record(wxSize,{type :: wxSizeEvent:wxSizeEventType(), %% Callback event: {@link wxSizeEvent}
	size :: {W::integer(), H::integer()},
	rect :: {X::integer(), Y::integer(), W::integer(), H::integer()}}).
-type wxSize() :: #wxSize{}. %% Callback event: {@link wxSizeEvent}

-record(wxSpin,{type :: wxSpinEvent:wxSpinEventType(), %% Callback event: {@link wxSpinEvent}
	commandInt :: integer()}).
-type wxSpin() :: #wxSpin{}. %% Callback event: {@link wxSpinEvent}

-record(wxSplitter, {type :: wxSplitterEvent:wxSplitterEventType()}). %% Callback event: {@link wxSplitterEvent}
-type wxSplitter() :: #wxSplitter{}. %% Callback event: {@link wxSplitterEvent}

-record(wxStyledText,{type :: wxStyledTextEvent:wxStyledTextEventType(), %% Callback event: {@link wxStyledTextEvent}
	position :: integer(),
	key :: integer(),
	modifiers :: integer(),
...
-record(wxSysColourChanged, {type :: wxSysColourChangedEvent:wxSysColourChangedEventType()}). %% Callback event: {@link wxSysColourChangedEvent}
-type wxSysColourChanged() :: #wxSysColourChanged{}. %% Callback event: {@link wxSysColourChangedEvent}

-record(wxTaskBarIcon, {type :: wxTaskBarIconEvent:wxTaskBarIconEventType()}). %% Callback event: {@link wxTaskBarIconEvent}
-type wxTaskBarIcon() :: #wxTaskBarIcon{}. %% Callback event: {@link wxTaskBarIconEvent}

-record(wxTree,{type :: wxTreeEvent:wxTreeEventType(), %% Callback event: {@link wxTreeEvent}
	item :: integer(),
	itemOld :: integer(),
	pointDrag :: {X::integer(), Y::integer()}}).
-type wxTree() :: #wxTree{}. %% Callback event: {@link wxTreeEvent}

-record(wxUpdateUI, {type :: wxUpdateUIEvent:wxUpdateUIEventType()}). %% Callback event: {@link wxUpdateUIEvent}
-type wxUpdateUI() :: #wxUpdateUI{}. %% Callback event: {@link wxUpdateUIEvent}

-record(wxWindowCreate, {type :: wxWindowCreateEvent:wxWindowCreateEventType()}). %% Callback event: {@link wxWindowCreateEvent}
-type wxWindowCreate() :: #wxWindowCreate{}. %% Callback event: {@link wxWindowCreateEvent}

-record(wxWindowDestroy, {type :: wxWindowDestroyEvent:wxWindowDestroyEventType()}). %% Callback event: {@link wxWindowDestroyEvent}
